...
const users = [
    {
        imageSrc: "https://www.gims.net.in/admission/img/stu/swati-mishra.webp",
        title: "Info Edge India",
        position: { x: "20%", y: "30%" },
        delay: 3000,
    },
    {
        imageSrc: "https://www.gims.net.in/admission/img/stu/12.webp",
        title: "Deloitte",
        position: { x: "80%", y: "20%" },
        delay: 3000,
    },
    {
        imageSrc: "https://www.gims.net.in/admission/img/stu/13.webp",
        title: "Decathlon",
        position: { x: "50%", y: "70%" },
        delay: 3000,
    },
    {
        imageSrc: "https://www.gims.net.in/admission/img/stu/14.webp",
        title: "Sonalika International",
        position: { x: "75%", y: "60%" },
        delay: 3000,
    },
    {
        imageSrc: "https://www.gims.net.in/admission/img/stu/15.webp",
        title: "ITC Limited",
        position: { x: "75%", y: "60%" },
        delay: 3000,
    },
    {
        imageSrc: "https://www.gims.net.in/admission/img/stu/16.webp",
        title: "Asian Paints Ltd",
        position: { x: "75%", y: "60%" },
        delay: 3000,
    },
    {
        imageSrc: "https://www.gims.net.in/admission/img/stu/17.webp",
        title: "Bandhan Bank",
        position: { x: "75%", y: "60%" },
        delay: 3000,
    },
    {
        imageSrc: "https://www.gims.net.in/admission/img/stu/18.webp",
        title: "Ujjivan Small Finance Bank",
        position: { x: "75%", y: "60%" },
        delay: 3000,
    },
    {
        imageSrc: "https://www.gims.net.in/admission/img/stu/19.webp",
        title: "HCLTech",
        position: { x: "75%", y: "60%" },
        delay: 3000,
    },
